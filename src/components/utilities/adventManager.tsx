...
export function adventManager({
    ...
    if (randomNumber < stormCurve(time % 720000, 16.7)) {
        setWeatherQueue(
        [...weatherQueue,
            {"id": advents.length + 1, "name": "Storm", "type": "Weather", "description": "Every time it rains, it rains pennies from heaven", "startTime": time, "length": 45000, "isOver": false}
        ]
        )
    }
    ...
    if (randomNumber < snowStormCurve(time % 720000, 16.7)) {
        setWeatherQueue(
        [...weatherQueue, 
            {"id": advents.length + 1, "name": "Snow Storm", "type": "Weather", "description": "Drops of rain frozen into ice crystals?", "startTime": time, "length": 45000, "isOver": false}
        ]
        );
    }
    ...
    if (randomNumber < heatWaveCurve(time % 720000, 16.7)) {
        setWeatherQueue(
        [...weatherQueue, 
            {"id": advents.length + 1, "name": "Heat Wave", "type": "Weather", "description": "When it's uber-hot", "startTime": time, "length": 30000, "isOver": false}
        ]
        );
    }
    ...
    if (randomNumber < tornadoCurve(time % 720000, 16.7)) {
        setWeatherQueue(
        [...weatherQueue, 
            {"id": advents.length + 1, "name": "Tornado", "type": "Weather", "description": "A violent vortex of rotating wind", "startTime": time, "length": 20000, "isOver": false}
        ]
        );
    }
    ...
    if (randomNumber < hurricaneCurve(time % 720000, 16.7)) {
        setWeatherQueue(
        [...weatherQueue, 
            {"id": advents.length + 1, "name": "Hurricane", "type": "Weather", "description": "A really big storm", "startTime": time, "length": 30000, "isOver": false}
        ]
        );
    }
    ...
    if (randomNumber < blizzardCurve(time % 720000, 16.7)) {
        setWeatherQueue(
        [...weatherQueue, 
            {"id": advents.length + 1, "name": "Blizzard", "type": "Weather", "description": "A really big snow storm", "startTime": time, "length": 30000, "isOver": false}
        ]
        );
    }
    ...
    if (randomNumber < 1/((15*720000)/16.7)) {
        setWeatherQueue(
        [...weatherQueue, 
            {"id": advents.length + 1, "name": "Blizzard", "type": "Weather", "description": "A really big snow storm", "startTime": time, "length": 10000, "isOver": false}
        ]
        );
    }
}